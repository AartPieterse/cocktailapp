...
**Still open:** cocktail *text* coverage has no equivalent gate — the harvester only prints it. 126/126 carry Dutch today, so the gate would pass; add it before the seed grows again.
